...
originations_filename = "Copy of LADR_Orig_SMF 20260601 - HyVee Springfield"
...
originations = pd.read_excel(fr'C:\Users\matthewray\OneDrive - Clearwater\Desktop\Ladder\Python\input_loan_orig\{originations_filename}.xlsx', header= 1)
...
originations['MaturityDate'] = pd.to_datetime(originations['MaturityDate'])
originations['MaturityDate'] = originations['MaturityDate'].dt.date
...
identifier_list = "', '".join(table2['Identifier'].astype(str).tolist())
